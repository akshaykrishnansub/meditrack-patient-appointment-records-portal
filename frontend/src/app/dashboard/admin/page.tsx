      ...
      <main className='flex-1 md:p-8 lg:ml-64 p-4 overflow-x-auto'>
        ...
        <div className='bg-white p-6 shadow rounded-lg mb-8'>
          ...
          <div className='mt-4 flex flex-col lg:flex-row gap-2'>
            <Link href="/dashboard/admin/create-doctor" className='text-white font-bold px-4 py-2 rounded bg-green-700 hover:bg-green-600'>Create Doctor</Link>
            <Link href="/dashboard/admin/users" className='text-white font-bold px-4 py-2 rounded bg-blue-700 hover:bg-blue-600'>Manage Users</Link>
            <Link href="/dashboard/admin/audit-logs" className='text-white font-bold px-4 py-2 rounded bg-purple-700 hover:bg-purple-600'>View Logs</Link>
          </div>
        </div>
      </main>
      {toast && (
