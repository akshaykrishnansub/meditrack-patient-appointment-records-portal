...
import { addDoctor, fetchAllAppointments, fetchAllUsers, fetchUserById, removeUser, updateExisitingUser, viewAllMedicalRecords, deleteMedicalRecord, viewMedicalRecordByAdmin, dashboardStats} from '../controllers/admin.controller.js';
